...
* Formatting:
    ...
    * For sources from the internet, use the Digital Object Identifier (DOI) instead of a URL if possible
...
* **Note Format**:
    * `<NOTE NUMBER>. Text generated by <LLM>, <COMPANY>, <DATE OF ACCESS>, <URL>`
    * **Example**:
